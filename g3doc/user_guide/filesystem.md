...
`(nil, nil)` to decline. The `SeccompRules` method declares any additional
syscalls the provider needs beyond the stock gofer allowlist (e.g. for
networking). See the `runsc/gofer/provider` package documentation and
