...
type Provider interface {
	...
	//
	// mountPath is the resolved, absolute destination inside the
	// container (e.g. "/storage/data"). conf describes the mount's
	// overlay and filesystem configuration. readonly indicates whether
	// the mount was configured as read-only.
	NewServer(mountPath string, conf specutils.GoferMountConf, readonly bool) (*lisafs.Server, error)
